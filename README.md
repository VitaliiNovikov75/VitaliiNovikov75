...
Я увлечен наукой о данных. В профессии около двух лет, пишу чистый и поддерживаемый код на Python. Имею опыт полного цикла разработки: от сбора требований и подготовки данных до развёртывания
