...
Я data scientis, пишу на Python. В профессии около двух лет. За это время создал более 24 проектов, которые включают в себя следующие этапы:
- сбор требований,
- создание ML модели (обучение, валидация, тестирование);
- обертывание ML модели в микросервис,
- вывод в production,
- поддержка в production.

Мой интерес - машинное обучение, компьютерное зрение и роботы гуманоиды. Создаю полезные продукты для бизнеса и людей.
